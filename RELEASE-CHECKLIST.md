...
- [ ] Recall one worker while the rule remains active; verify that pawn does not immediately restart the same job, another worker may continue, and the hold clears after a different meaningful activity starts.
