...
- Individual Recall now prevents the same managed job from being recreated on the next AI think cycle and holds only until the pawn starts a different meaningful activity.
