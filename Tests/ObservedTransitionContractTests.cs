...
namespace AutomaticOutfitManager.UI {public static class PawnAutomaticOutfitStatus {public const string OwningStatus="Automatic Outfit Manager: Restoring saved apparel\nRule: Kitchen\nBuffer: 0/1\nRestoring saved apparel: Flak vest";public static int Calls;public static string Build(Pawn pawn){Calls++;return OwningStatus;}}}
