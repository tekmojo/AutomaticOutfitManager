...
$sources = @('Tests/StorageFilterContractTests.cs', 'Source/Storage/ManagedApparelClassifier.cs', 'Source/Storage/ManagedWeaponClassifier.cs', 'Source/Storage/SpecialThingFilterWorkers.cs', 'Source/Patches/ThingFilter_SetAllow_Patch.cs') | ForEach-Object { Join-Path $rcRoot $_ }
try {
