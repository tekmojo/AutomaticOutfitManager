...
The **Workers** section includes every qualifying worker, including pawns who already had every required item before work began. All receive the same **Recall** action. An already-compliant session tracks the work without changing, claiming, or restoring the pawn's personal outfit.
